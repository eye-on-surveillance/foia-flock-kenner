"""Stage 1: aggregate the raw Network Audit files into cache/network_audit.csv.

Reads:  raw-response/Flock Data/Network Audit/*.csv  (25 monthly files)
Writes: cache/network_audit.csv  (one physical line per record, header included)

Run from anywhere:  python3 setup-scripts/01_aggregate_network_audit.py

10.3 million rows, expect it to take a few minutes.
"""
...
RAW_DIR = PROJECT_ROOT / "raw-response" / "Flock Data" / "Network Audit"
OUT_FILE = PROJECT_ROOT / "cache" / "network_audit.csv"
